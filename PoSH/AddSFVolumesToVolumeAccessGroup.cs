...
namespace SolidFire.element
{
	...
	/// </summary>
	[RunInstaller(true)]
	[Cmdlet(VerbsCommon.Add, "SFVolumesToVolumeAccessGroup")]
	public class AddVolumesToVolumeAccessGroup : SFCmdlet
	{
		#region Private Data
		/// <summary>
		...
		[Parameter(HelpMessage = "[u'List of volumes to add to this volume access group.']")]
		...
		{
			base.ProcessRecord();
			var request = new AddVolumesToVolumeAccessGroupRequest();
			request.VolumeAccessGroupID = _volumeAccessGroupID;
			request.Volumes = _volumes;
			var objsFromAPI = SendRequest<AddVolumesToVolumeAccessGroupResult>("AddVolumesToVolumeAccessGroup", request);
