...
namespace SolidFire.element
{
	...
	/// </summary>
	[RunInstaller(true)]
	[Cmdlet(VerbsCommon.Add, "SFInitiatorsToVolumeAccessGroup")]
	public class AddInitiatorsToVolumeAccessGroup : SFCmdlet
	{
		#region Private Data
		/// <summary>
		...
		[Parameter(HelpMessage = "[u'List of initiators to add to the volume access group.']")]
		...
		{
			base.ProcessRecord();
			var request = new AddInitiatorsToVolumeAccessGroupRequest();
			request.VolumeAccessGroupID = _volumeAccessGroupID;
			request.Initiators = _initiators;
			var objsFromAPI = SendRequest<AddInitiatorsToVolumeAccessGroupResult>("AddInitiatorsToVolumeAccessGroup", request);
